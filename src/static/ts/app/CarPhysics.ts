...
export default class CarPhysics {
    ...
    public static init() {
        ...
        this.wheels = [CarWheels.frontLeft, CarWheels.frontRight, CarWheels.rearLeft, CarWheels.rearRight];
    ...
    private static createVehicleWheel(tuning: Ammo.btVehicleTuning, front: boolean, position: Ammo.btVector3, radius: number): Ammo.btWheelInfo {
        const info: Ammo.btWheelInfo = this.vehicle.addWheel(position, new Ammo.btVector3(0, -1, 0), new Ammo.btVector3(-1, 0, 0), this.suspensionRestLength, radius, tuning, front);
